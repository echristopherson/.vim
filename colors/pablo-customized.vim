...
let g:colors_name = "pablo-customized"
...
highlight Statement  ctermfg=3			   cterm=none guifg=#c0c000				  gui=none " I'm trying to reduce the boldness of this scheme, but even when I set this to none it looks the same. 
